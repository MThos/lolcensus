"""
Django settings for lolcensus project.
...
SECRET_KEY = '8(_si413)y4hi&u!9v0iib1el_ie!v(%)8z8(4r+!-p$as51d9'
...
WSGI_APPLICATION = 'lolcensus.wsgi.application'
